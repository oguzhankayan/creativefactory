...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    faqs: [
      { q: "Çekim ekibi sizde mi?", a: "Evet, kendi çekim ve set ekibimiz var. Ek lokasyon veya oyuncu gerekirse partner ağımızdan çağırıyoruz." },
  ...
  },
  {
    ...
    intro: "Performans pazarlama, ölçülebilir reklam demek. Her kampanyanın bir KPI'sı, her kuruşun bir hesabı var. Beğeniden değil, kazandığın müşteriden ölçüyoruz.",
  ...
  },
  {
    ...
    seoDescription: "Reklam filmi, 3D motion grafik, stop motion ve video içerik üretimi. İç ekipte prodüksiyon ve post-prodüksiyon; renk yönetimi ve seslendirme dahil.",
